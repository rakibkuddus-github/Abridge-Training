 ...
 * 
 */
@WebServiceClient(name = "RPNCalculatorService", targetNamespace = "http://wellsfargo.com", wsdlLocation = "http://localhost:8080/RPNCalculatorWS/services/RPNCalculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RPNCALCULATORSERVICE_QNAME = new QName("http://wellsfargo.com", "RPNCalculatorService");
    ...
    public RPNCalculator getRPNCalculator() {
        return super.getPort(new QName("http://wellsfargo.com", "RPNCalculator"), RPNCalculator.class);
    }
    ...
    public RPNCalculator getRPNCalculator(WebServiceFeature... features) {
        return super.getPort(new QName("http://wellsfargo.com", "RPNCalculator"), RPNCalculator.class, features);
    }
